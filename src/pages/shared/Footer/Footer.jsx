      ...
      <aside>
        <div>
          ...
          <p className="font-bold w-[200px] lg:w-[500px] mx-auto">
            <span className="text-[18px]">Travel Tribe</span> <br />
          ...
          <nav className="space-x-2 my-2">
            <Link class="link link-hover">Home</Link>
            <Link class="link link-hover">Contact</Link>
            <Link class="link link-hover">All Tours</Link>
            <Link class="link link-hover">Countries</Link>
          </nav>
        </div>
        <p className="font-medium">Copyright © 2024 - All right reserved</p>
      </aside>
      <nav>
        <div className="grid grid-flow-col gap-4 text-[#2E5F47] font-bold">
          <Link>
            <svg
